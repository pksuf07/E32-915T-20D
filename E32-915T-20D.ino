/**
 * E32-915T-20D modfified from E32-TTL-100 (https://github.com/Bob0505/E32-TTL-100) Transceiver Interface
 */
#include <Arduino.h>
#include <SoftwareSerial.h>
#include "E32-915T-20D.h"
...
bool chkModeSame(MODE_TYPE mode)
{
  ...
  if(pre_mode == mode) {
    //Serial.print("SwitchMode: (no need to switch) ");  Serial.println(mode, HEX);    return true;
  } else {
...
RET_STATUS Read_module_version(struct MVerstruct* MVer)
{
  ...
  if(STATUS == RET_SUCCESS) {
    ...
    Serial.println("Module version read error");
  }
